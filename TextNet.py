...
def build_G_from_S(S, k=5, eplison=0.6):
...
class TextNet(nn.Module):
    def __init__(self, y_dim, bit, norm=True, mid_num1=1024, mid_num2=1024, hiden_layer=2):
        """
    ...
    def forward(self, x):
        ...
        x1 = F.normalize(x)
        S = x1.mm(x1.t())
        G = build_G_from_S(S,k=5, eplison=0.6)
